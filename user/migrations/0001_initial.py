    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('EP', 'Employee'), ('JS', 'Job Seeker'), (
                    'OC', 'Open To Collaborate'), ('OW', 'Owner')], max_length=2, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, choices=[('IG', 'Instagram'), ('FB', 'Facebook'), ('TW', 'Twitter'), ('SP', 'Snapchat'), ('TT', 'TikTok'), (
                    'TG', 'Telegram'), ('DB', 'Dribble'), ('PT', 'Pinterest'), ('RD', 'Reddit'), ('SC', 'SoundCloud'), ('DA', 'DeviantArt')], max_length=2, null=True)),
                ('username', models.CharField(blank=True, max_length=255, null=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='socials', to='user.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Link',
            fields=[
                ...
                ('profile', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, related_name='links', to='user.profile')),
            ],
        ),
    ]
